...
SERVOS: Dict[str, Dict[str, Any]] = {
    "STS3215": {
        ...
        "mass_g": 55.0,
        "rated_torque_nm": 0.98,                # ★ 官方「额定负载」10 kg·cm @12V
        "rated_torque_note": (
            "【2026-09-11 补权威出处】此前记『额定 1.0 N·m 无权威出处、已弃用』——"
            "现已有三个官方出处，原值 1.0 N·m 方向正确：\n"
            "  ① DFRobot SER0070（12V 30kg 版）参数表：额定负载 **10 kg.cm** = 0.98 N·m；\n"
            "  ② 飞特《产品规格书》STS3235（同为 12V/30kg 级）5-8：额定负载 **10 kg.cm**；\n"
            "  ③ 飞特《产品规格书》STS3215（7.4V 版）5-8：额定负载 **5 kg.cm** = 0.49 N·m。\n"
            "含义：额定负载＝可持续工作扭矩（对应 900 mA 额定电流），不是堵转。\n"
            "⚠️ 因此『堵转 × 50% = 1.47 N·m』这条判据**比官方额定乐观 50%**："
            "官方口径下单腿支撑 1.037 N·m ≈ 额定的 106%。详见 "
            "design/handoff/STS3215-官方规格书核验.md"
        ),
        "stall_torque_nm": 3.0,
