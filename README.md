...
| **干涉总量** | **189～190 对 / ≈160 300 mm³**（让位不足 115 · 局部干涉 74） | ⚠️ 级为主，多为同关节配合面，随几何改动小幅浮动 |
| **结构件质量** | **1390.4 g / 81 件**（CAD 实算；薄壁近似对 3 mm 壁件退化为实心 ⇒ 读作**上限**） | 合入前 1490 g，再减 **−7%** |
| **整机质量** | **≈3036 g（纸面推算，重量方案未定案）** | = 结构实算 + 舵机 1210 + 电子电池 316 + 线束 120；URDF 冻结基线 3436.6 g |
...
| **结构件质量** | URDF link 质量合计 3436.6 g（历史冻结口径） | **1390.4 g / 81 件（CAD 实算，读作上限）** | 历史链 1790 → 1404 → 1490 → **1390.4**；薄壁近似对 3 mm 壁件退化为实心，故为上限 |
| **整机总质量** | 历史提交口径 3437 g | **≈3036 g（纸面推算，重量方案未定案）** | 结构实算 + 舵机 1210 + 电子件与电池 316 + 线束紧固件 120 |
...
- 结构件实算 **1390.4 g / 81 件**（合入前 1490 g，−7%）；整机纸面推算 **≈3036 g**；URDF 已回灌至 3.0367 kg。
